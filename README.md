...
Dans PowerBI, "CONCATENATEX" va permettre d'afficher un KPI dynamique (A contrario, en remplacant "ASC" par "DESC" on obtiendra les causes les moins fréquentes).
